...
- **FR-029**: 系统必须在非表达式模型被添加时，弹出企业选择窗口，企业列表按以下优先级排序：数据资源所属企业 > 模型所属企业 > 算力所属企业 > 其他企业（同类型内按名称字母序），选择后显示该企业的可用模型列表
...
- **FR-035**: 系统必须在算力资源拖拽释放时弹出企业选择窗口，企业列表按以下优先级排序：数据资源所属企业 > 模型所属企业 > 算力所属企业 > 其他企业（同类型内按名称字母序），选择后显示该企业的可用算力列表
...
- **FR-040**: 系统必须在参与方企业选择中按以下优先级排序显示企业：数据资源所属企业 > 模型所属企业 > 算力所属企业 > 其他企业（同类型内按名称字母序），也支持选择全网其他企业
...
#### 本地计算任务
- **FR-046**: 系统必须在用户拖拽"本地结果处理任务"到画布释放时弹出参与方企业选择窗口，企业列表按以下优先级排序：数据资源所属企业 > 模型所属企业 > 算力所属企业 > 其他企业（同类型内按名称字母序）
